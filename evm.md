...
TUTORIAL: Fill in the semantics of `MSTORE`.
...
TUTORIAL: Fill in the semantics of `GASLIMIT`, `NUMBER`, `MSIZE`, and `CODECOPY`.
...
```{.k .uiuck .rvk}
 ...
 // ---------------------------------
    rule <mode> EXECMODE </mode>
         <k> CODESIZE => #sizeOpCodeMap(PGM) ~> #push ... </k> <program> PGM </program>
